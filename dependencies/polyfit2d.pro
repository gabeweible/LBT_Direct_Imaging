...
; CATEGORY:
;	E2 - Surface fitting and mathematics
; CALLING SEQUENCE:
...
; INPUT KEYWORDS:
;   min,max      = determines what kind of extrema should be evaluated
...
;	Changed and extended to POLYFIT2D by Juergen Hofmann, Feb. 1992
...
;
;	FIRST OF ALL: THE MINIMIZATION - SUBROUTINES AND FUNCTIONS
