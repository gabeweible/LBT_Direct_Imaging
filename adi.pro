...
writefits, strcompress(output_folder + dither_folder + obj_name + inj_string + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' + string(neg_inj) + '_uncert_' + string(uncert) +  '_median_derot.fits', /rem), medframe
...
writefits, strcompress(output_folder + dither_folder + obj_name + inj_string + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' + string(neg_inj) + '_uncert_' + string(uncert) +  '_median_derot_adi.fits', /rem), adiframe
...
writefits, strcompress('/Users/gabeweible/OneDrive/research/HII1348/macbook_' + string(coadd) + '/combined/' + obj_name + '_nods_adi' + suffix + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' + string(neg_inj) + '_uncert_' + string(uncert) +  '.fits', /rem), adinods

if runs eq 4 then begin
   e = mean(adinods, dim=3)
   writefits, strcompress('/Users/gabeweible/OneDrive/research/HII1348/macbook_' + string(coadd) + '/combined/' + obj_name + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' + string(neg_inj) + '_uncert_' + string(uncert) +  '_total_adi.fits', /rem), e
   ...
   find_sources,strcompress('/Users/gabeweible/OneDrive/research/HII1348/macbook_' + string(coadd) +$
       '/combined/' +obj_name + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' +$
        string(neg_inj) + '_total_adi.fits',/rem),reference=output_folder+dither_folder+obj_name+$
   ...
   writefits, strcompress('/Users/gabeweible/OneDrive/research/HII1348/macbook_' + string(coadd) + '/combined/' + obj_name + '_left_adi' + suffix + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' + string(neg_inj) + '_uncert_' + string(uncert) +  '.fits', /rem), e

   e = mean(adinods[*,*,2:3], dim=3)
   writefits, strcompress('/Users/gabeweible/OneDrive/research/HII1348/macbook_' + string(coadd) + '/combined/' + obj_name + '_right_adi' + suffix + 'ct_' + string(ct) +   'filt_'  +  string(filter) + '_neg_inj_' + string(neg_inj) + '_uncert_' + string(uncert) +  '.fits', /rem), e
endif
