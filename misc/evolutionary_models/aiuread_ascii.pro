...
;
;       datatype deleted (old) and double instead of float, May 2007,
; tschmidt ;-
pro aiuread_ascii, fn, a, NCOL=ncol, QUIET=quiet, COMMENT=comment, COMM_CHAR=comm_char,skip=skip
