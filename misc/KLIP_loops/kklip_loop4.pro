pro kklip_loop4, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
kklip_arr=[4,7,11,22,14,28];[4,5,6,7];[4,5,6,7];new array from initial results;[8,9]; partially complete;[2, 3, 4, 5, 6, 7, 8, 9]
angsep_arr=[0.24,0.27,0.30,0.33,0.36,0.39,0.42,0.45,0.48,0.51];[0.05, 0.06, 0.07, 0.7, 0.8, 0.9];[0.25/fwhm, 0.5/fwhm, 0.75/fwhm, 1.0/fwhm, 2.0/fwhm, 3.0/fwhm, 3.25/fwhm, 3.5/fwhm, 3.75/fwhm, 4.0/fwhm, 5.0/fwhm]

bin_type_arr = ['median']
combine_type_arr = ['median']
filter_arr = [0.0,37.];[30., 40., 50., 60., 70., 80., 90.]
n_ang_arr = [1,2]
...
save, filename=output_path+'/kklip_loop_arrays4.sav',kklip_arr, angsep_arr, filter_arr,$
