pro kklip_loop_rdi_new4, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
filter_arr = [16.34*0.9, 16.34, 16.34*1.1];[30., 40., 50., 60., 70., 80., 90.]
n_ang_arr = [1]
...
corr_thresh_arr = [0.9976, 0.9977, 0.9978, 0.9979, 0.9980]
