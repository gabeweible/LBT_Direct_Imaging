pro kklip_loop_rdi_new_low_k, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
kklip_arr=[5, 6, 7, 8, 9, 10, 11, 12]
angsep_arr=[0.255, 0.265, 0.275, 0.285, 0.295, 0.305, 0.315, 0.325]

bin_type_arr = ['median', 'mean']
combine_type_arr = ['nwadi', 'median']
filter_arr = [26., 39., 52.];[30., 40., 50., 60., 70., 80., 90.]
n_ang_arr = [2]
bin_arr = [10];I should probably try lower coadds as well!

annmode_inout=[7, 34]; nwadi needs 2 extra px on either side if I want more than
