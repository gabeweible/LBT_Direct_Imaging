pro kklip_loop_adi_new, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
keep_number_arr = [1205, 1210, 1215, 1220]
		...
		foreach combine_type, combine_type_arr do begin
				foreach filter, filter_arr do begin
					...
					alcor_pipeline, pre_inj=pre_inj, neg_inj=0, coadd=coadd,$
						...
						normal=normal, peak_clean=0, stddev_clean=0
