pro kklip_loop_adi_new3, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
keep_number_arr = [1060, 1070, 1080, 1090, 1110, 1120, 1130, 1140]
	
;peak_thresh_arr = [0.9]
	
;stddev_thresh_arr = [0.9, 1, 1.1, 1.2, 1.3, 1.4, 1.5]
		...
		foreach combine_type, combine_type_arr do begin
				foreach filter, filter_arr do begin
					...
					alcor_pipeline, pre_inj=pre_inj, neg_inj=0, coadd=coadd,$
						...
						save_basis=0, pa_off=pa_off, peak_thresh=0.90,$
						normal=normal, peak_clean=1, stddev_clean=0
