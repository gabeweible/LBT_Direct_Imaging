pro kklip_loop_rdi2, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
anglemax_arr = [30., 35., 40., 45., 360.] ; max. parallactic angle between ref. and science frame
...
save, filename=output_path+'/kklip_loop_arrays_rdi2.sav',kklip_arr, angsep_arr, filter_arr,$
				...
				foreach filter, filter_arr do begin
					...
					foreach angsep, angsep_arr do begin
						...
						foreach k_klip, kklip_arr do begin
							...
							do_dewarp=do_dewarp, save_basis=save_basis, anglemax=anglemax, rdi_extra='2', extra='rdi2'
