pro rdi_loop_update3, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
n_ang_arr = [1]
bin_arr = [2];I should probably try lower coadds as well!
