...
kklip_arr = (findgen(20) + 1.)/2. * 20.
angsep_arr=[0.0000000000000001, 0.025, 0.05, 0.75, 0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25,$
	0.275, 0.3]
...
; Alcor cubes
refcube1 = readfits_fast(output_path+'/processed_right/dith1/Alcor     0.997500_cube_skysub_cen_clean.fits')
refcube2 = readfits_fast(output_path+'/processed_right/dith2/Alcor     0.997500_cube_skysub_cen_clean.fits')
