pro kklip_loop_rdi_final_ann2, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
annmode_inout=[32+26-2+26-2+26-2+26-2+26-2+26-2, 32+26-2+26-2+26-2+26-2+26-2+26-2+26]; nwadi needs 2 extra px on either side if I want more than
...
anglemax_arr = [34.] ; max. parallactic angle between ref. and science frame
					...
					foreach angsep, angsep_arr do begin
						...
						foreach k_klip, kklip_arr do begin
							...
							alcor_pipeline, pre_inj=0, neg_inj=0, coadd=coadd,$
								...
								rdi_extra='final_ann2', extra='rdi_final_ann2',$
