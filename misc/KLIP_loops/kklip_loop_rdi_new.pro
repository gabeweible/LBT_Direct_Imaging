pro kklip_loop_rdi_new, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
kklip_arr = (findgen(20) + 1.)/2. * 10.
angsep_arr=[0.0000000000000001, 0.025, 0.05, 0.075, 0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25,$
	0.275, 0.3]

bin_type_arr = ['median', 'mean']
combine_type_arr = ['median', 'nwadi', 'mean']
...
anglemax_arr = [360., 45., 40., 35., 30., 25.] ; max. parallactic angle between ref. and science frame
...
; Alcor cubes
refcube1 = readfits(output_path+'/processed_right/dith1/Alcor     0.997500_cube_skysub_cen_clean.fits')
refcube2 = readfits(output_path+'/processed_right/dith2/Alcor     0.997500_cube_skysub_cen_clean.fits')
