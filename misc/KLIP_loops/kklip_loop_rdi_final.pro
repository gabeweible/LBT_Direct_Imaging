pro kklip_loop_rdi_final, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
kklip_arr=[9,10,11,12,13]
angsep_arr=[0.263, 0.265, 0.267, 0.269, 0.271, 0.273, 0.275, 0.275, 0.277]

bin_type_arr = ['median']
combine_type_arr = ['mean', 'median']
filter_arr = [29.]
n_ang_arr = [2]
bin_arr = [10];I should probably try lower coadds as well!
annmode_inout=[8,34]; nwadi needs 1 extra px on either side?
anglemax_arr = [33., 34., 36., 38., 40., 42., 44., 45.] ; max. parallactic angle between ref. and science frame
					...
					foreach angsep, angsep_arr do begin
						...
						foreach k_klip, kklip_arr do begin
							...
							alcor_pipeline, pre_inj=0, neg_inj=0, coadd=coadd,$
								...
								rdi_extra='final', extra='rdi_final',$
