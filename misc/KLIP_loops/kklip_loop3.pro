pro kklip_loop3, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
;+
; NAME:
;       MASK_RESIDUALS
...
kklip_arr=[30,34,38,42,46,50,54,58,62];[4,5,6,7];[4,5,6,7];new array from initial results;[8,9]; partially complete;[2, 3, 4, 5, 6, 7, 8, 9]
fwhm=13.0773; M-band
angsep_arr=randomu(seed, 10);[0.05, 0.06, 0.07, 0.7, 0.8, 0.9];[0.25/fwhm, 0.5/fwhm, 0.75/fwhm, 1.0/fwhm, 2.0/fwhm, 3.0/fwhm, 3.25/fwhm, 3.5/fwhm, 3.75/fwhm, 4.0/fwhm, 5.0/fwhm]
...
save, filename=output_path+'/kklip_loop_arrays3.sav',kklip_arr, angsep_arr, filter_arr
