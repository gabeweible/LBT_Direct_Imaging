pro kklip_loop6, kklip_arr=kklip_arr, angsep_arr=angsep_arr, bin_arr=bin_arr
...
kklip_arr=[7,8,9,10,11,19];[4,5,6,7];[4,5,6,7];new array from initial results;[8,9]; partially complete;[2, 3, 4, 5, 6, 7, 8, 9]
...
save, filename=output_path+'/kklip_loop_arrays6.sav',kklip_arr, angsep_arr, filter_arr,$
